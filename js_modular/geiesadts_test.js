...
function runtests(require, exports, chai, adts, samples) {
  ...
  var 
    ...
    newItem = adts.newItem,
    right = adts.right,
    left = adts.left,
    isRight = adts.isRight,
    isLeft = adts.isLeft,
    either_fmap = adts.either_fmap,
    some = adts.some,
    isSome = adts.isSome,
    none = adts.none,
    isNone = adts.isNone,
    maybe_fmap = adts.maybe_fmap,
    empty = adts.empty,
    leaf = adts.leaf,
    node = adts.node,
    item = adts.item,
    child = adts.child,
    children = adts.children,
    parent = adts.parent,
    subtree = adts.subtree,
    count = adts.count,
    depth = adts.depth,
    insert = adts.insert,
    ...
    sms = samples.sms,
    sdk = samples.sdk,
    cp_telfort = samples.cp_telfort,
    leaf2 = samples.leaf2,
    subtree1 = samples.subtree1,
    tree1 = samples.tree1,
    route3 = samples.route3
  ;
